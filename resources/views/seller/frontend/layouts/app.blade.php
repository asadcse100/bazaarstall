...
<head>
    ...
    <!-- Favicon -->
    @php
        $site_icon = uploaded_asset($shop->fav_icon);
    @endphp
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column bg-white">
        ...
        @endphp
        <!-- Header -->
        @include('seller.frontend.layouts.inc.nav')

        @yield('content')
        
        <!-- footer -->
        @include('seller.frontend.layouts.inc.footer')

    </div>

    <!-- Floating Buttons -->
    @include('seller.frontend.layouts.inc.floating_buttons')
